...
### Fixed
- Show immediate, accessible feedback when the hosted OAuth Connect form is missing or has a malformed service token.
- Show a connecting state while the service token is being authorized, while retaining recoverable server-side errors.
...
[1.4.2]: https://github.com/PipeOpsHQ/pipeops-mcp/releases/tag/v1.4.2
